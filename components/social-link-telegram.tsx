...
const SocialLinkTelegram = memo(function SocialLinkTelegram() {
  ...
  return (
    <a
      ...
      className={`social-link-button ${isHovered ? "hovered" : ""} ${isClicked ? "button-pulse-active" : ""} zero-gravity-sync-tertiary-delayed`}
    ...
    >
      ...
      <style jsx>{`
        .social-link-button {
          ...
          line-height: 1.2;
          min-width: auto;
          animation: soft-pulse 5.8s ease-in-out infinite alternate; /* Individual animation */
        }
...
export default SocialLinkTelegram
